...
class EnrichInfant(Processor):
    ...
    async def process_infants_with_more_than_14_rings(self, record):
...
class EnrichMale(Processor):
    ...
    async def process_males_heavy_and_short(self, record):
        # data = super().stream_data()
        # Simulating each record feeding to the processor
        # for record in data:
        # Logic to consider appropiate records
...
class FilterAbalone(Processor):
    ...
    async def process_shell_humidity(self, record):
        # data = super().stream_data()
        # Simulating each record feeding to the processor
        # for record in data:
